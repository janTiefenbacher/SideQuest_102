-- Quest System Tables for OnlyFriends App - UPDATED WITH PHOTO QUESTS
...
-- Insert sample quest templates with PHOTO QUESTS
...
('Spiegel-Selfie', 'Erstelle ein kreatives Spiegel-Selfie', 'medium', 22, 'Foto'),
('Street Art', 'Fotografiere ein Graffiti oder Street Art Kunstwerk', 'medium', 28, 'Foto'),
('Tier-Foto', 'Mache ein Foto von einem Tier (Hund, Katze, Vogel, etc.)', 'medium', 20, 'Foto'),

-- Hard Quests
('Community Event', 'Organisiere ein größeres Event für deine Freundesgruppe', 'hard', 50, 'Führung'),
('Foto-Serie', 'Erstelle eine 5-teilige Foto-Serie zu einem Thema', 'hard', 60, 'Foto'),
('Freundschaftsbrücke', 'Verbinde zwei deine Freunde, die sich noch nicht kennen', 'hard', 40, 'Sozial'),
('Nacht-Fotografie', 'Mache ein beeindruckendes Foto bei Nacht oder in der Dämmerung', 'hard', 45, 'Foto'),
('Portrait-Challenge', 'Fotografiere 3 verschiedene Menschen in kreativen Posen', 'hard', 55, 'Foto'),
('Makro-Fotografie', 'Erstelle ein detailliertes Makro-Foto von etwas Kleinem', 'hard', 50, 'Foto'),
('Action-Foto', 'Fotografiere eine Sport- oder Bewegungsaktivität', 'hard', 48, 'Foto');
